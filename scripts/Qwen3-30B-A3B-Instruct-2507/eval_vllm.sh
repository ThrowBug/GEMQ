...
case "${model_variant}" in
    FP) served_model_name="${SERVED_MODEL_NAME:-qwen3-30b-a3b-2507-fp}" ;;
    FQ) served_model_name="${SERVED_MODEL_NAME:-qwen3-30b-a3b-2507-fq}" ;;
...
echo "=============================================="
echo ">>> Qwen3-30B-A3B-Instruct-2507 EvalScope API evaluation"
